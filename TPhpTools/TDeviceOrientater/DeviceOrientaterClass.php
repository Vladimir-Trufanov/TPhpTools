...
// *                                                                          *
// * v2.2, 19.01.2022                              Автор:       Труфанов В.Е. *
...
class DeviceOrientater
{
   ...
   protected $_Orient;           // текущая ориентация устройства;
   // ------------------------------------------------------- МЕТОДЫ КЛАССА ---
   public function __construct($SiteDevice=oriComputer) 
   {
      ...
      // Сбрасываем ориентацию устройства в js-переменную DeviceOrientater_Orient 
      $this->MakeOrient(); 
      // Уточняем ориентацию устройства (вводим в переменную класса)
      $this->_Orient=oriLandscape;
      if (IsSet($_REQUEST['orient']))
      { 
         if ($_REQUEST['orient']==oriPortrait) $this->_Orient=oriPortrait;
      }
   }
   // *************************************************************************
   // *          Указать положение устройства, в которое оно переведено       *
   ...
   // *************************************************************************
   // * Сбросить ориентацию устройства в js-переменную DeviceOrientater_Orient 
   // *************************************************************************

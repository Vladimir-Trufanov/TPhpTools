...
define ("TArticlesMakerDir", pathPhpTools.'/TArticlesMaker');  
...
class ArticlesMaker
{
   ...
   private function Zero()
   {
      ...
      // загружаем из класса 
      CompareCopyRoot('ArticlesMaker.js',TArticlesMakerDir,jsxdir);
      CompareCopyRoot('ArticlesMaker.css',TArticlesMakerDir,$this->stylesdir);
   ...
   {
      // <script src="/Jsx/ArticlesMaker.js"></script>
      echo '<script src="/'.jsxdir.'/ArticlesMaker.js"></script>';
   }
   // *************************************************************************
